...
const ScChoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5858bf0336d57aa6be98f098e00034a4f6b0cd59', tabindex: "0", onFocus: () => this.input.focus() }, index.h("div", { key: '1a0756598f6d7712ebe511463165f637fcb7244b', part: "base", class: {
                'choice': true,
            ...
            }, onKeyDown: e => this.handleKeyDown(e), onMouseDown: e => this.handleMouseDown(e) }, index.h("slot", { key: '54c7a665a5aecafede848ec35e1b3e341545f23f', name: "header" }), index.h("label", { key: '11c7cd848d7891baa92f4fcb951f26d1c335df88', class: "choice__content", part: "content", htmlFor: this.inputId }, index.h("span", { key: '2103161a6e04701cf3e18b39fc84f57a17a3b540', part: "control", class: {
                choice__control: true,
                choice__checkbox: this.type === 'checkbox',
                choice__radio: this.type === 'radio',
            }, hidden: !this.showControl }, index.h("span", { key: '181d18641584e8abbbadbff7b207ced75a44d440', part: "checked-icon", class: "choice__icon" }, this.type === 'checkbox' ? (index.h("svg", { viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd", "stroke-linecap": "round" }, index.h("g", { stroke: "currentColor", "stroke-width": "2" }, index.h("g", { transform: "translate(3.428571, 3.428571)" }, index.h("path", { d: "M0,5.71428571 L3.42857143,9.14285714" }), index.h("path", { d: "M9.14285714,0 L3.42857143,9.14285714" })))))) : (index.h("svg", { viewBox: "0 0 16 16" }, index.h("g", { stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, index.h("g", { fill: "currentColor" }, index.h("circle", { cx: "8", cy: "8", r: "3.42857143" })))))), index.h("input", { key: '7c53cf872f534959833875eb4b8df1a4ec55d159', id: this.inputId, ref: el => (this.input = el), type: this.type, name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', "aria-labelledby": this.labelId, tabindex: "0",
            // required={this.required}
            onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleClickEvent() })), index.h("span", { key: '36e98fc7def4bec49242b84539975a295f78c842', part: "label", id: this.labelId, class: "choice__label" }, index.h("span", { key: '5f2cca11f9829d4f35d882caa5f394bc3180602f', class: "choice__label-text", hidden: !this.showLabel }, index.h("span", { key: '2b43635ccbd275887ea6837c755fd19ee213f10a', class: "choice__title", part: "title" }, index.h("slot", { key: '9f308fa824da12705f098b6910630086f8368d5d', onSlotchange: () => this.handleSlotChange() })), index.h("span", { key: 'a113ba1219a4241c3e62a33bbf8663780a267f37', class: "choice__description description", part: "description", hidden: !this.hasDescription }, index.h("slot", { key: '0f14f6303e9873450d96c46d5338150f3c343f3a', name: "description", onSlotchange: () => this.handleSlotChange() }))), index.h("span", { key: '266a66adf8f64b66c8eff25a2e2dd3341bae6d33', class: "choice__price", hidden: !this.showPrice || (!this.hasPrice && !this.hasPer) }, index.h("span", { key: '27a8eae4441b2969eb4789bf27bc59b20b7204c0', class: "choice__title" }, index.h("slot", { key: '3ec3d09ed1cc6f607b82ef15c8a4e14261330746', name: "price", onSlotchange: () => this.handleSlotChange() })), ' ', index.h("span", { key: '95da01f0b5b35aaf06d023d3ce9e05a5725fa37c', class: "choice__description" }, index.h("slot", { key: '5850a1af491e7a928b432f6ba4187425a50bafa0', name: "per", onSlotchange: () => this.handleSlotChange() }))))), index.h("slot", { key: '643e8395789b51538f4c1072b950cb2257d703c1', name: "footer" }))));
    }
