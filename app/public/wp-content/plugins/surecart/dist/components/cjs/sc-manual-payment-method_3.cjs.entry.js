...
const ScManualPaymentMethod = class {
    ...
    render() {
        var _a, _b;
        return (index.h("div", { key: '94b07ec4a596e02d7ad15ac979c4606e2a7d1351', class: "manual-payment-method", part: "card" }, index.h("div", { key: 'a658684b04d1777ca53f7b4c084a6fab5f549f3f', class: "payment-method__title" }, (_a = this.paymentMethod) === null || _a === void 0 ? void 0 : _a.name), this.showDescription && index.h("sc-prose", { key: '48f5f9e74d7009b16e2d03993923539fd8273979', class: "payment-method__description", innerHTML: (_b = this.paymentMethod) === null || _b === void 0 ? void 0 : _b.description })));
    }
};
...
const ScProse = class {
    ...
    render() {
        return (index.h(index.Host, { key: '854f47c3ca56fa25b78bf2a9bbc6773a994d827a' }, index.h("slot", { key: 'f2e0fda672932a5b612a2ac50957f0f69e703f7e' })));
    }
};
