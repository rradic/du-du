...
const ScForm = class {
    ...
    render() {
        return (index.h("div", { key: 'ebe71e73e1bb4ac7f3f02094d88657d0d31b0604', part: "base", class: "form", role: "form" }, index.h("form", { key: 'c4bbd52d2aed9466a0173ccbefe6482a5cb860bd', part: "form", ref: el => (this.formElement = el), class: "test", onSubmit: async (e) => {
                e.preventDefault();
            ...
            }, novalidate: this.novalidate }, index.h("slot", { key: '63db5a4bde4f200efb46fef106c34e0603c9d9d8' }))));
    }
