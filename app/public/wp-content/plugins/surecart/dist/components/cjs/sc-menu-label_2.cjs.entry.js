...
const ScMenuLabel = class {
    ...
    render() {
        return (index.h("div", { key: '7e7e7eb3900df80912ad8f798520f50be3375458', part: "base", class: "menu-label" }, index.h("slot", { key: '47238b7b70be7ecd9a93d0d4152eeb026a3fe4ea' })));
    }
};
...
const ScSelectDropdown = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '68683040050e22d42b281de4277db7c4c029455f', part: "base", class: {
                'select': true,
            ...
            } }, index.h("sc-form-control", { key: 'bb73c49e745198737d4b9937948313d844bc275e', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("input", { key: '82773dcd23982f391a5db4655f4dd5c58d516531', class: "select__hidden-input", name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled, "aria-hidden": "true", "aria-label": this.displayValue() || this.label || this.placeholder, onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() }), index.h("sc-dropdown", { key: '3740ef7e084a6767aae1ddcf98ba69c71f7b40b6', exportparts: "trigger, panel", disabled: this.disabled, open: this.open, closeOnSelect: this.closeOnSelect, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide(), role: "select", "aria-open": this.open ? 'true' : 'false' }, index.h("slot", { key: 'a64baf1e94809d1dbc3d6ee6f16e942876c07905', name: "trigger", slot: "trigger" }, index.h("div", { key: 'e159068dc4c3f38c1d68a1d6d6aa332f2a9d0db6', class: "trigger", role: "button", tabIndex: -1, onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() }, index.h("div", { key: '1ceccad638cb81155f484b56397c201ad62205f6', class: "select__value" }, index.h("slot", { key: 'ac648746adfdf074771443f7c37dd8e06b5da63b' }, this.displayValue() || this.placeholder || wp.i18n.__('Select...', 'surecart'))), index.h("sc-icon", { key: 'f50c09fcd9ecec7be30ad2e7217e41106332d419', exportparts: "base:caret", class: "select__caret", name: "chevron-down" }))), this.search && (index.h("sc-input", { key: '349b0523187b24411473c29d03bd70ca358d3958', exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || wp.i18n.__('Search...', 'surecart'), onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", value: this.searchTerm, ref: el => (this.searchInput = el), "aria-label": wp.i18n.__('Type to search', 'surecart'), onKeyDown: e => e.stopPropagation() }, this.loading && index.h("sc-spinner", { key: '5554320c519bfc9720c277f7a095baade6a4e060', exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), index.h("sc-menu", { key: 'b90327f7074b375bd7a8b7e410e10c9b86ab9193', style: { maxHeight: '210px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e), "aria-multiselectable": "false" }, index.h("slot", { key: '39d5ba88616e0409aed589b8e783506ac1c1e506', name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
            return [this.renderItem(choice, index), (choice.choices || []).map(choice => this.renderItem(choice, index))];
        }), this.loading && (index.h("div", { key: 'b4ee30141d0480b394433c05e0805c25ac7f3578', class: "loading" }, index.h("sc-spinner", { key: 'c56c0d1deddf19328e549f01ce881791abc96809', exportparts: "base:spinner__base" }))), !this.loading && !this.filteredChoices.length && (index.h("div", { key: 'fa5f5c684e8c0ff8e06f93197eb7e48a91f52e6f', class: "select__empty", part: "empty" }, wp.i18n.__('Nothing Found', 'surecart'))), index.h("slot", { key: 'ed737037da49ea52c4c0ce2578df6cc28b961631', name: "suffix" }))))));
    }
