...
const ScFormControl = class {
    ...
    render() {
        return (index.h("div", { key: 'a59d29bc6e5be063405f74099a221444191b43b1', part: "form-control", class: {
                'form-control': true,
            ...
            } }, index.h("label", { key: '9c943d0e31c558320ebe24c57d513594a932b89b', part: "label", id: this.labelId, class: "form-control__label", htmlFor: this.inputId, "aria-hidden": !!this.label ? 'false' : 'true' }, index.h("slot", { key: '46f43cc6519cc45d178375619a010bc4ba96c0b9', name: "label" }, this.label), index.h("slot", { key: '160d284d4a47cb554ff9d7be9d8457b8646fa102', name: "label-end" }), !!this.required && (index.h("span", { key: 'd425ec357e9ccb40ce3dbe6fdadf18c97c8dddd1', "aria-hidden": "true", class: "required" }, ' ', "*")), index.h("sc-visually-hidden", { key: '1b2ddddd86a20dc17cfead8962019c270c585942' }, !!this.required ? wp.i18n.__('required', 'surecart') : '')), index.h("div", { key: '1997aa16948572fcf65d16ea8957f740c8c6eb03', part: "input", class: "form-control__input" }, index.h("slot", { key: '5c8c34ec97263219eadea1ec9b9481c423c62089' })), this.help && (index.h("div", { key: '7a90843957ac3cbc4d08bd050421c5113cb60feb', part: "help-text", id: this.helpId, class: "form-control__help-text" }, index.h("slot", { key: 'ded3a447811b73073f8cc0746505794c35721709', name: "help-text" }, this.help)))));
    }
...
const ScInput = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '15948295751e51e9686836ca132ffff667303aed', hidden: this.hidden }, index.h("sc-form-control", { key: '5285deef70758868b795063a5eac0e8761994b05', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("slot", { key: '9d005d724f12d8af970c48259e0a0fb3202f0c20', name: "label-end", slot: "label-end" }), index.h("div", { key: 'aae50bc23400a8ac4c9f185f346f043c591d4549', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } })), index.h("span", { key: '1bf15539208960897471e55bb51e12cc213409e8', part: "suffix", class: "input__suffix" }, index.h("slot", { key: 'b0e5ae345562599ab40ff20db2c20c0f628d84d1', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (index.h("button", { key: '07a3760b473fb53187fb1428c480fdb9cb042c61', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, index.h("slot", { key: '866eccc8a6373a3efb0287c69a9bf7854fa81b93', name: "clear-icon" }, index.h("svg", { key: '9c2c3c07e1eed286c8e27de1dfe80163401187cb', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, index.h("line", { key: 'd7fa0c4cbe219ae628d490e188afb8b649464d26', x1: "18", y1: "6", x2: "6", y2: "18" }), index.h("line", { key: '55eeae162ec58810193000365f49fe433b0c3abd', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
    get el() { return index.getElement(this); }
