...
const ScChoices = class {
    ...
    render() {
        return (index.h("fieldset", { key: '2068f3bf9935f82757aea9dfee13d51c673a68ae', part: "base", class: {
                'choices': true,
            ...
            }, role: "radiogroup" }, index.h("sc-form-control", { key: 'caf80489bc75fe9591e21db1ff42f8efbdd5e956', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId }, index.h("div", { key: '3f65f258ed012aa81bec1f333254e1635458bcc0', part: "choices", class: "choices__items" }, index.h("slot", { key: 'f9301571f5277c6095d250d0768e412657ea9940' })))));
    }
