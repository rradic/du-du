...
const ScPassword = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '5dc92980dc16fa7331b5fd3d18ec271e7120dd1b', class: "password" }, index.h("div", { key: 'd8715a1d7f8ce722ec3faea3e00c3455144012b6' }, index.h("sc-input", { key: 'f7f5f1f2b3b16b653127b1e47f8f3643488e5016', ref: el => (this.input = el), label: this.label, help: this.help, autofocus: this.autofocus, placeholder: this.placeholder, showLabel: this.showLabel, size: this.size ? this.size : 'medium', type: "password", name: "password", value: this.value, required: this.required, disabled: this.disabled, onScInput: () => this.handleValidate() }), !!this.hintText && index.h("small", { key: '01ac00189b62ce8e6e85c81bb27d118541517f44', class: "password__hint" }, this.hintText)), this.confirmation && (index.h("div", { key: '7e82a44b8e7985a37c21fbcddff21fadb0c7ce69' }, index.h("sc-input", { key: 'e765ade791105217214c0b8e3a92fbbacca4daa8', ref: el => (this.confirmInput = el), label: (_a = this.confirmationLabel) !== null && _a !== void 0 ? _a : wp.i18n.__('Confirm Password', 'surecart'), help: this.confirmationHelp, placeholder: this.confirmationPlaceholder, size: this.size ? this.size : 'medium', type: "password", value: this.value, onScInput: () => this.handleVerification(), required: this.required, disabled: this.disabled }), !!this.verifyText && index.h("small", { key: 'afc2d328972b6965791fabb09d166206fdb56324', class: "password__hint" }, this.verifyText)))));
    }
