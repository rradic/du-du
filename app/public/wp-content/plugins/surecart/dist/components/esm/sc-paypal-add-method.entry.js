...
const ScPaypalAddMethod = class {
    ...
    render() {
        return (h(Host, { key: '99b6aaa570727d206cc37cfe55fa04ea87072bc7' }, this.error && (h("sc-alert", { key: '3e3765a43fa5b67ca72cb11815be68a148dace88', open: !!this.error, type: "danger" }, h("span", { key: 'f0ae56e1672bbd87c74c3d8cae8929ce4998cf4e', slot: "title" }, wp.i18n.__('Error', 'surecart')), this.error)), h("div", { key: 'b99ad82af69bab5eee7d883e24d958aee189f202', class: "sc-paypal-button-container", hidden: !this.loaded, ref: el => (this.container = el) })));
    }
