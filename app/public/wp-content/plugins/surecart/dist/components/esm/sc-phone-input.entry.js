...
const ScPhoneInput = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: 'a93a86f5800f643eb982a42a976b4d7345bb0413', hidden: this.hidden }, h("sc-form-control", { key: 'b820c9cec4a99bf752b453302509dca8d5301b51', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name, "aria-label": this.label }, h("slot", { key: 'cc460018f9dcbad9ce1e0b024360323098b4e161', name: "label-end", slot: "label-end" }), h("div", { key: 'ddfa51c4e980317738a3e21e0a07a2179ffaf01d', part: "base", class: {
                'input': true,
                // Sizes
            ...
            } }, h("span", { key: '55fe8a7de83d31a11721166884e9e6ad6a935d8b', part: "prefix", class: "input__prefix" }, h("slot", { key: '7e70ece04b0e0121d6e93618cb31304dc22a6faf', name: "prefix" })), h("slot", { key: '8527685b754852cd18d2d0eb684329132638bc93' }, h("input", { key: '6767fe28e6a2f72f921bea5e41567be29f547710', part: "input", id: this.inputId, class: "input__control", ref: el => (this.input = el), type: "tel", name: this.name, disabled: this.disabled, readonly: this.readonly, required: this.required, placeholder: this.placeholder, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step,
            // TODO: Test These below
            autocomplete: 'tel', autocorrect: this.autocorrect, autofocus: this.autofocus, spellcheck: this.spellcheck, pattern: applyFilters('surecart/sc-phone-input/pattern', this.pattern), inputmode: 'numeric', "aria-label": this.label, "aria-labelledby": this.label, "aria-invalid": this.invalid ? true : false, value: this.value, onChange: () => this.handleChange(), onInput: () => this.handleInput(), onFocus: () => this.handleFocus(), onBlur: () => this.handleBlur() })), h("span", { key: '36610c56fb281bca04a760d6534270acef908116', part: "suffix", class: "input__suffix" }, h("slot", { key: '0205385d7b2bf4092402ec985de56a2a1ce599ff', name: "suffix" })), this.clearable && ((_a = this.value) === null || _a === void 0 ? void 0 : _a.length) > 0 && (h("button", { key: '2e822fa356380cba13776c090e5c1a98205d217e', part: "clear-button", class: "input__clear", type: "button", onClick: e => this.handleClearClick(e), tabindex: "-1" }, h("slot", { key: 'b3e58593159fa1f4ef4076051aff43cadc558da9', name: "clear-icon" }, h("svg", { key: '3074a931a49a35edb1f961a6a9530239bfa88669', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "feather feather-x" }, h("line", { key: '2e1e9248c3e862332287d89939d2b206a71ab601', x1: "18", y1: "6", x2: "6", y2: "18" }), h("line", { key: '621273e093eeea811dce89fa6a0f43faacd92c75', x1: "6", y1: "6", x2: "18", y2: "18" })))))))));
    }
