...
const ScMenuLabel = class {
    ...
    render() {
        return (h("div", { key: '7e7e7eb3900df80912ad8f798520f50be3375458', part: "base", class: "menu-label" }, h("slot", { key: '47238b7b70be7ecd9a93d0d4152eeb026a3fe4ea' })));
    }
};
...
const ScSelectDropdown = class {
    ...
    render() {
        var _a;
        return (h("div", { key: '68683040050e22d42b281de4277db7c4c029455f', part: "base", class: {
                'select': true,
