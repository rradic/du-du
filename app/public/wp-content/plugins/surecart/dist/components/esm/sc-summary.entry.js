...
const ScOrderSummary = class {
    ...
    render() {
        return (h("div", { key: '0090970f1d30b99ee33eddcd8c66df7e4fb3d6af', class: { 'summary': true, 'summary--open': !this.collapsed } }, this.collapsible && this.renderHeader(), h("div", { key: '06a71891afc3d282e833274750413d629ca1c656', ref: el => (this.body = el), class: {
                summary__content: true,
            } }, h("slot", { key: '43fa920dea0e64a37c3a613f08b479e0807af60d' }))));
    }
