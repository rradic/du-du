...
const ScOrderBump = class {
    ...
    renderPrice() {
        ...
        return (h("div", { slot: "description", class: { 'bump__price': true, 'bump__price--has-discount': !!((_a = this.bump) === null || _a === void 0 ? void 0 : _a.percent_off) || !!((_b = this.bump) === null || _b === void 0 ? void 0 : _b.amount_off) }, part: "price" }, h("span", { "aria-label": 
            ...
            wp.i18n.sprintf(wp.i18n.__('Originally priced at %s.', 'surecart'), (_c = this.bump) === null || _c === void 0 ? void 0 : _c.subtotal_display_amount), class: "bump__original-price" }, (_d = this.bump) === null || _d === void 0 ? void 0 : _d.subtotal_display_amount), h("span", null, h("span", { "aria-hidden": "true" }, ((_e = this.bump) === null || _e === void 0 ? void 0 : _e.total_amount) === 0 && wp.i18n.__('Free', 'surecart'), ((_f = this.bump) === null || _f === void 0 ? void 0 : _f.total_amount) > 0 && h("span", { class: "bump__new-price" }, (_g = this.bump) === null || _g === void 0 ? void 0 : _g.total_display_amount), this.renderInterval()))));
    }
    renderDiscount() {
        var _a, _b, _c, _d, _e, _f, _g;
    ...
    render() {
        ...
        return (h("sc-choice", { key: '3a0ed05bf6118a3ae8c2353e0f32252a795b78e7', value: (_c = this.bump) === null || _c === void 0 ? void 0 : _c.id, type: "checkbox", showControl: this.showControl, checked: !!this.lineItem(), onClick: e => {
                e.preventDefault();
            ...
            }, exportparts: "base, control, checked-icon, title" }, h("div", { key: '2940569588c586800ea703c858f979f6f0fdab38', part: "base-content", class: "bump" }, h("div", { key: '4472d2a08e702cf634edc0a4593a2e73c31c93a9', class: "bump__text" }, h("div", { key: '3cd90fcef88f57c03e34ac7d7dba5c557f6cf58b', class: "bump__title", "aria-label": wp.i18n.sprintf(
            /* translators: %s: order bump name */
            wp.i18n.__('Product: %s.', 'surecart'), ((_e = (_d = this.bump) === null || _d === void 0 ? void 0 : _d.metadata) === null || _e === void 0 ? void 0 : _e.cta) || ((_f = this.bump) === null || _f === void 0 ? void 0 : _f.name) || (product === null || product === void 0 ? void 0 : product.name)) }, h("span", { key: 'ec87da3800e261fa351a71d769c119f2a68d8201', "aria-hidden": "true" }, ((_h = (_g = this.bump) === null || _g === void 0 ? void 0 : _g.metadata) === null || _h === void 0 ? void 0 : _h.cta) || ((_j = this.bump) === null || _j === void 0 ? void 0 : _j.name) || (product === null || product === void 0 ? void 0 : product.name))), h("div", { key: '34f1a259327190c0699814eb575ecf5245ee7139', class: "bump__amount" }, this.renderPrice(), this.renderDiscount()))), ((_l = (_k = this.bump) === null || _k === void 0 ? void 0 : _k.metadata) === null || _l === void 0 ? void 0 : _l.description) && (h("div", { key: 'd2c6f532c53700f30eae79d58e2f8262c48869ac', slot: "footer", class: "bump__product--wrapper" }, h("sc-divider", { key: '2de413be6332ea9b68d1c1abb1c6def4c8ab1df0', style: { '--spacing': 'var(--sc-spacing-medium)' } }), h("div", { key: '6777d3324a35d3f7247e674af6f2d546bf378556', class: "bump__product" }, !!((_m = product === null || product === void 0 ? void 0 : product.line_item_image) === null || _m === void 0 ? void 0 : _m.src) && h("img", { key: '0a9ca344c017f0dbe5a47d6c1988bc669ee7f558', ...product === null || product === void 0 ? void 0 : product.line_item_image, class: "bump__image" }), h("div", { key: '949d651c907e79fd3175d37518946f8384a39987', class: "bump__product-text" }, !!((_p = (_o = this.bump) === null || _o === void 0 ? void 0 : _o.metadata) === null || _p === void 0 ? void 0 : _p.cta) && (h("div", { key: '3777e5da185c0b7bc70a2433467440eea2228ea3', class: "bump__product-title", "aria-hidden": "true" }, this.bump.name || (product === null || product === void 0 ? void 0 : product.name))), !!((_r = (_q = this.bump) === null || _q === void 0 ? void 0 : _q.metadata) === null || _r === void 0 ? void 0 : _r.description) && (h("div", { key: '8dc755d7a7e0573994da3f389acc560d9a8b05f6', class: "bump__product-description", "aria-label": wp.i18n.sprintf(
            /* translators: %s: Product description */
            wp.i18n.__('Product description: %s.', 'surecart'), (_t = (_s = this.bump) === null || _s === void 0 ? void 0 : _s.metadata) === null || _t === void 0 ? void 0 : _t.description) }, h("span", { key: 'dd66dd9fe986464023283cffab4be898149896bd', "aria-hidden": "true" }, (_v = (_u = this.bump) === null || _u === void 0 ? void 0 : _u.metadata) === null || _v === void 0 ? void 0 : _v.description)))))))));
    }
};
...
const ScRadio = class {
    ...
    render() {
        ...
        return (h(Tag, { key: '0894940d7506ba9f500385b7f304e5b748071b39', part: "base", class: {
                'radio': true,
                'radio--checked': this.checked,
                'radio--disabled': this.disabled,
                'radio--focused': this.hasFocus,
                'radio--editing': this.edit,
            }, htmlFor: this.inputId, onKeyDown: e => this.handleKeyDown(e), onMouseDown: e => this.handleMouseDown(e) }, h("span", { key: 'aedfc958c6fed40c5d7ca9f7c4ba186332235cfb', part: "control", class: "radio__control" }, h("span", { key: '264d4ac9898d655d134a70a37ca71730058c8352', part: "checked-icon", class: "radio__icon" }, h("svg", { key: '72f8d8717d2544e1a6992e97bd37e16f88914363', viewBox: "0 0 16 16" }, h("g", { key: '48a3d9fe8cdda6184bd50b539e507ab2213333cb', stroke: "none", "stroke-width": "1", fill: "none", "fill-rule": "evenodd" }, h("g", { key: 'c43c937eeb33db2d1a66778152ad57e4db76a5f8', fill: "currentColor" }, h("circle", { key: '98e9d605ba231d0201dac48ec075acd07aadaea2', cx: "8", cy: "8", r: "3.42857143" }))))), h("input", { key: '1445b1029e5a91a1fa19a64fbc2b8a5dc3b93a98', id: this.inputId, ref: el => (this.input = el), type: "radio", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, required: this.required, "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus() })), h("span", { key: '5bcbec305ae0c0b589666bd7afbeb283837af821', part: "label", id: this.labelId, class: "radio__label" }, h("slot", { key: '6bab4c42dac246fd656f8acaa3773098ad071f58' }), h("slot", { key: '4ac8ed9823583e9d9d029cae311e5efd10386a6d', name: "description" }))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const ScRadioGroup = class {
    ...
    render() {
        return (h("fieldset", { key: 'b01eed0c4db08fe9bf5c27bf0d2620ca7a3aef06', part: "base", class: {
                'radio-group': true,
                'radio-group--invalid': this.invalid,
                'radio-group--is-required': this.required,
                'radio-group--is-rtl': isRtl(),
            }, "aria-invalid": this.invalid, role: "radiogroup" }, h("legend", { key: 'b5b99177ce06b13b8e5f6b2b51c28205076c858b', part: "label", class: "radio-group__label" }, h("slot", { key: '4f6c0646658e02bb0c763ec03d4102d734c8a239', name: "label" }, this.label)), h("input", { key: 'c5fa85141c3c93d6d6efab536fc5b000bb98e27c', type: "text", class: "radio-group__hidden-input", ref: el => (this.input = el), required: this.required, value: this.value, tabindex: "-1" }), h("div", { key: '55fa72770dc1bb137b878cdfa0beab0896c8d69e', part: "items", class: "radio-group__items" }, h("slot", { key: '2a591203bf069f5cc5ae4988f258c9198b12f18a' }))));
    }
    get el() { return getElement(this); }
};
